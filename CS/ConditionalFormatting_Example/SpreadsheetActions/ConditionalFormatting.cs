    ...
    class ConditionalFormatting
    {
        ...
        static void AddColorScale2ConditionalFormatting(IWorkbook workbook)
        {
            ...
            try
            {
                ...
                ConditionalFormattingExtremumValue minPoint = conditionalFormattings.CreateExtremumValue();
                // Set the maximum threshold to the highest value in the range of cells, which is evaluated automatically.
                ConditionalFormattingExtremumValue maxPoint = conditionalFormattings.CreateExtremumValue();
        ...
        static void AddColorScale3ConditionalFormatting(IWorkbook workbook)
        {
            ...
            try
            {
                ...
                ConditionalFormattingExtremumValue minPoint = conditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Formula, "=MIN($C$2:$D$15)");
                // Set the midpoint threshold to the 50th percentile.
                ConditionalFormattingInsideValue midPoint = conditionalFormattings.CreateInsideValue(ConditionalFormattingValueType.Percentile, "50");
                // Set the maximum threshold to the highest value in the range of cells using the MAX() formula.
                ConditionalFormattingExtremumValue maxPoint = conditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Number, "=MAX($C$2:$D$15)");
        ...
        static void AddDataBarConditionalFormatting(IWorkbook workbook)
        {
            ...
            try
            {
                ...
                ConditionalFormattingExtremumValue lowBound1 = conditionalFormattings.CreateExtremumValue();
                // Set the value corresponding to the longest bar to the highest value, which is evaluated automatically.
                ConditionalFormattingExtremumValue highBound1 = conditionalFormattings.CreateExtremumValue();
                ...
                ConditionalFormattingExtremumValue lowBound2 = conditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Percent, "0");
                // Set the value corresponding to the longest bar to 100 percent.
                ConditionalFormattingExtremumValue highBound2 = conditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Percent, "100");
        ...
        static void AddIconSetConditionalFormatting(IWorkbook workbook)
        {
            ...
            try
            {
                ...
                ConditionalFormattingIconSetInsideValue minPoint = conditionalFormattings.CreateIconSetInsideValue(ConditionalFormattingValueType.Formula, "=MIN($E$2:$E$15)", ConditionalFormattingValueOperator.GreaterOrEqual);
                // Set the second threshold to 0.
                ConditionalFormattingIconSetInsideValue midPoint = conditionalFormattings.CreateIconSetInsideValue(ConditionalFormattingValueType.Number, "0", ConditionalFormattingValueOperator.GreaterOrEqual);
                // Set the third threshold to 0.01.
                ConditionalFormattingIconSetInsideValue maxPoint = conditionalFormattings.CreateIconSetInsideValue(ConditionalFormattingValueType.Number, "0.01", ConditionalFormattingValueOperator.GreaterOrEqual);
                ...
                IconSetConditionalFormatting cfRule = conditionalFormattings.AddIconSetConditionalFormatting(worksheet.Range["$E$2:$E$15"], IconSetType.Arrows3, new ConditionalFormattingIconSetInsideValue[] { minPoint, midPoint, maxPoint });
