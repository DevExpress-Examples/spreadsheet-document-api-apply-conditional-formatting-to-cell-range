...
'				#Region "#AverageConditionalFormatting"
				...
				Dim cfRule2 As AverageConditionalFormatting = conditionalFormattings.AddAverageConditionalFormatting(worksheet("$D$2:$D$15"), ConditionalFormattingAverageCondition.BelowOrEqual, 1)
...
'				#Region "#RangeConditionalFormatting"
				...
				Dim cfRule As RangeConditionalFormatting = worksheet.ConditionalFormattings.AddRangeConditionalFormatting(worksheet("$F$2:$F$15"), ConditionalFormattingRangeCondition.Outside, "7", "19")
				' Specify formatting options to be applied to cells if the condition is true.
				' Set the background color to yellow.
...
'				#Region "#ColorScale2ConditionalFormatting"
                Dim conditionalFormattings As ConditionalFormattingCollection = worksheet.ConditionalFormattings
                ' Set the minimum threshold to the lowest value in the range of cells, which is evaluated automatically.
                Dim minPoint As ConditionalFormattingExtremumValue = conditionalFormattings.CreateExtremumValue()
                ' Set the maximum threshold to the highest value in the range of cells, which is evaluated automatically.
                Dim maxPoint As ConditionalFormattingExtremumValue = conditionalFormattings.CreateExtremumValue()
...
'				#Region "#ColorScale3ConditionalFormatting"
                ...
                Dim minPoint As ConditionalFormattingExtremumValue = conditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Formula, "=MIN($C$2:$D$15)")
                ' Set the midpoint threshold to the 50th percentile.
                Dim midPoint As ConditionalFormattingInsideValue = conditionalFormattings.CreateInsideValue(ConditionalFormattingValueType.Percentile, "50")
                ' Set the maximum threshold to the highest value in the range of cells using the MAX() formula.
                Dim maxPoint As ConditionalFormattingExtremumValue = conditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Number, "=MAX($C$2:$D$15)")
...
'				#Region "#DataBarConditionalFormatting"
                ...
                Dim lowBound1 As ConditionalFormattingExtremumValue = conditionalFormattings.CreateExtremumValue()
                ' Set the value corresponding to the longest bar to the highest value, which is evaluated automatically.
                Dim highBound1 As ConditionalFormattingExtremumValue = conditionalFormattings.CreateExtremumValue()
                ...
                Dim lowBound2 As ConditionalFormattingExtremumValue = conditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Percent, "0")
                ' Set the value corresponding to the longest bar to 100 percent.
                Dim highBound2 As ConditionalFormattingExtremumValue = conditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Percent, "100")
...
'				#Region "#IconSetConditionalFormatting"
                ...
                Dim minPoint As ConditionalFormattingIconSetInsideValue = conditionalFormattings.CreateIconSetInsideValue(ConditionalFormattingValueType.Formula, "=MIN($E$2:$E$15)", ConditionalFormattingValueOperator.GreaterOrEqual)
                ' Set the second threshold to 0.
                Dim midPoint As ConditionalFormattingIconSetInsideValue = conditionalFormattings.CreateIconSetInsideValue(ConditionalFormattingValueType.Number, "0", ConditionalFormattingValueOperator.GreaterOrEqual)
                ' Set the third threshold to 0.01.
                Dim maxPoint As ConditionalFormattingIconSetInsideValue = conditionalFormattings.CreateIconSetInsideValue(ConditionalFormattingValueType.Number, "0.01", ConditionalFormattingValueOperator.GreaterOrEqual)
                ...
                Dim cfRule As IconSetConditionalFormatting = conditionalFormattings.AddIconSetConditionalFormatting(worksheet.Range("$E$2:$E$15"), IconSetType.Arrows3, New ConditionalFormattingIconSetInsideValue() {minPoint, midPoint, maxPoint})
